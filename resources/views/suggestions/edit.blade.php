              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{ route("suggestions.update", $suggestion->id) }}">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="titre" class="form-control @error('titre') is-invalid @enderror" value="{{ $suggestion->title }}" required>
                      @error('titre')
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control @error('details') is-invalid @enderror" name="details" style="height: 100px" required>{{ $suggestion->details }}</textarea>
                      @error('details')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
