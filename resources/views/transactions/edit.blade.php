                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('transactions.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" name="account_id" required>
                                            @foreach ($accounts as $account2)
                                                <option value="{{$account2->id}}" {{ $transaction->account->id == $account2->id ? 'selected' : '' }} >
                                                    {{$account2->numero}}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" name="type">
                                            <option {{$transaction->type == "retrait"? 'selected': ''}} value="retrait">
                                                Rétrait
                                            </option>
                                            <option {{$transaction->type == "depot"? 'selected': ''}} value="depot">
                                                Dépot
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" value="{{ $transaction->montant }}" name="montant"
