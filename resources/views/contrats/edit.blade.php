                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('contrats.update', $contrat->id) }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" name="debut" value="{{ $contrat->debut }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" name="fin" value="{{ $contrat->fin }}"
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail" class="col-sm-2 col-form-label  ">Heure
                                        Début</label>
                                    <div class="col-sm-10">
                                        <input type="time" name="heure_debut" value="{{ $contrat->heure_debut }}"
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail" class="col-sm-2 col-form-label">Heure
                                        Fin</label>
                                    <div class="col-sm-10">
                                        <input type="time" name="heure_fin" value="{{ $contrat->heure_fin }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select @error('user_id') is-invalid @enderror " name="user_id">
                                            <option value="{{ $contrat->user->id }}">{{ $contrat->user->name }}
                                                {{ $contrat->user->surname }}
                                                ({{ $contrat->user->role }})
                                            </option>
                                        </select>
                                        @error('user_id')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="horraire" value="{{ $contrat->horraire }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="salaire_de_base"
                                            value="{{ $contrat->salaire_de_base }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="logement" value="{{ $contrat->logement }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="transport" value="{{ $contrat->transport }}"
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" name="responsable_id">
                                            @foreach ($users as $user)
                                                <option {{ $user->id == $contrat->responsable_id ? 'selected' : '' }}
                                ...
                                <div class="row mb-3">
                                    <label for="" class="col-sm-2 col-form-label">Lister les responsabilités de
                                        l'employé(e)</label>
                                    <div class="col-sm-10">
